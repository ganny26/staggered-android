...
import com.bacon.demo.application.FontManager;
...
public class FontIconDrawable extends Drawable {
     ...
     */
    public FontIconDrawable(Context context, String icon, Typeface typeface, int color) {
   ...
   /* public FontIconDrawable(Context context, String icon, Typeface typeface) {
            this(context,icon,typeface,Color.WHITE);
    }*/

    public FontIconDrawable(Context context, String icon,int color) {
        this(context,icon, FontManager.getTypeface(context,FontManager.FONTAWESOME),color);
    }

    public FontIconDrawable(Context context, int iconstring,int color) {
        this(context, context.getResources().getString(iconstring), FontManager.getTypeface(context,FontManager.FONTAWESOME),color);
    }
